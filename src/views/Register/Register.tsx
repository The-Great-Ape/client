...
export function RegisterView() {
  const [avatar] = React.useState(getParam("avatar"));
  const [discordId] = React.useState(getParam("discord_id"));
  const [userId] = React.useState(getParam("user_id"));
  const [provider] = React.useState(getParam("provider"));
  const [serverName] = React.useState(getParam("serverName"));
  const [serverLogo] = React.useState(
    decodeURIComponent(getParam("serverLogo"))
  );
  const [isRegistered] = React.useState(
    decodeURIComponent(getParam("is_registered"))
  );
      ...
      <Box>
        ...
        <div className="overlap">
          <Circle padding={false}>
            <img src={`/server-logos/${serverLogo}`} alt="grape-logo" />
          </Circle>
          <Circle padding={false}>
            {provider === "discord" && (
              <img
